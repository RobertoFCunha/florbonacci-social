        ...
        for (
          ...
          const list =
            reactionsByDiscovery.get(
              reaction.discovery_id,
            ) ?? []

          list.push(reaction)

          reactionsByDiscovery.set(
            reaction.discovery_id,
            list,
          )
        }

        const commentsByDiscovery =
          new Map<
            string,
            CommentView[]
          >()
                  ...
                  >
                    <div>
                      <button
                        ...
                        aria-label={`Ver perfil de ${discovery.authorName}`}
                      >
                        {
